...
import { Stack, Title, Divider, Text, Textarea, Button, Group, LoadingOverlay, Paper } from "@mantine/core";
...
const BasicCheckup = () => {
	...
	const isHandleBeforeFileDisabled = data?.status === TestRecordStatus.CHO_KET_QUA;
			...
			<Stack>
				...
				<form onSubmit={form.onSubmit(onSubmit)} style={{ position: "relative" }}>
					...
					<Group position="center">
						<Button variant="outline" mt="sm" onClick={handleTestBeforeFile} disabled={isHandleBeforeFileDisabled}>
